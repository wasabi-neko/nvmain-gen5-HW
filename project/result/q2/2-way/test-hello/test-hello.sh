...
result_path=/home/user/project/result/q2/2-way/test-hello
...
${gem5_path}/build/X86/gem5.opt ${gem5_path}/configs/example/se.py -c ${hello} ${arg} > ${result_path}/q2-result