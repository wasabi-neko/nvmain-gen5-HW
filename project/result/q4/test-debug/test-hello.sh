...
result_path=/home/user/project/result/q4/test-debug
...
${gem5_path}/build/X86/gem5.opt --debug-flags=Cache ${gem5_path}/configs/example/se.py -c ${hello} ${arg} > ${result_path}/result